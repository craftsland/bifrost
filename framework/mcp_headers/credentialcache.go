...
// cached.
func (c *headerCredentialCache) Fill(key string, fill func() (cachedHeaderCredential, error)) (cachedHeaderCredential, error) {
	if c == nil {
		return fill()
	}
	return c.cache.Fill(key, func() (cachedHeaderCredential, string, error) {
		value, err := fill()

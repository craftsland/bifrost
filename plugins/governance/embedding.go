...
// embedding provider. Semantic complexity classification falls back to the
// configured fallback mechanism while it is nil. Safe for concurrent use with
// classification and plugin reloads.
